"use strict";
let menu, animate, isRtl = window.Helpers.isRtl(),
    ...
    function () {
        ...
        document.getElementById("layout-menu") && function (e, t) {
            ...
            e.onmouseenter = function () {
                ...
                document.querySelector(".layout-menu-toggle").classList.remove("d-block"), clearTimeout(s)
            }
        ...
        if (window.templateCustomizer && s) {
            ...
            "light" === o ? (e.classList.add("bx-sun"), new bootstrap.Tooltip(e, {
                title: "Light Mode",
                fallbackPlacements: ["bottom"]
            })) : "dark" === o ? (e.classList.add("bx-moon"), new bootstrap.Tooltip(e, {
                title: "Dark Mode",
                fallbackPlacements: ["bottom"]
            })) : (e.classList.add("bx-desktop"), new bootstrap.Tooltip(e, {
                title: "System Mode",
                fallbackPlacements: ["bottom"]
            }))
        }
        var a;
        "system" === (a = o) && (a = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), [].slice.call(document.querySelectorAll("[data-app-" + a + "-img]")).map((function (e) {
        ...
        }), !0), !isHorizontalLayout && !window.Helpers.isSmallScreen() && ("undefined" != typeof TemplateCustomizer && (window.templateCustomizer ? window.Helpers.setCollapsed(!0, !1) : window.Helpers.setCollapsed(!1, !1)), "undefined" != typeof config && config.enableMenuLocalStorage)) try {
    ...
    if (e.length && e.on("click", (function () {
        ...
        s.each((function () {
            ...
            s.typeahead({
                ...
                s.val(""), e.typeahead("val", ""), t.addClass("d-none"), o.addClass("fade").removeClass("show")
            })), s.on("keyup", (function () {
