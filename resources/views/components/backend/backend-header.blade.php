...
<div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
    ...
    <div class="navbar-nav align-items-center">
        <div class="nav-item d-flex align-items-center cursor-pointer" data-bs-toggle="modal" data-bs-target="#globalSearchModal">
            <i class="bx bx-search fs-4 lh-0 me-2"></i>
            <span class="text-muted d-none d-md-inline-block">Search (Ctrl+/)</span>
        </div>
    </div>
    <!-- /Search -->
